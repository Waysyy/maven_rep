...
public class Main {
    ...
    public void FirstTest() throws InterruptedException {
        System.setProperty("webdriver.chrome.driver","A:\\GitProjects\\maven_rep\\mavenProject\\drivers\\chromedriver-win64\\chromedriver.exe");
        ...
        driver.findElement(By.xpath("//*[@class='input-0-2-71']")).sendKeys("testlabs00");
        ...
        Thread.sleep(Duration.ofSeconds(2).toMillis());
        driver.findElement(By.xpath("//*[@class='input-0-2-71 withIcon-0-2-72']")).sendKeys("iSy%TpeO4aP3");
        driver.findElement(By.xpath("//*[@class='inner-0-2-81 innerTextWrapper-0-2-82']")).click();
        ...
        Assert.assertEquals("test tester",driver.findElement(By.xpath("//*[@class='ph-name svelte-1popff4']")).getText());
